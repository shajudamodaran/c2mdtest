export const outsideRes = [
  ...
  { title: "You will not authorize others to use your account;" },
  {
    title:
...
export const outsideRefund = [
  { title: "100% refund to the patient if Doctor cancels the appointment." },
  {
    title:
